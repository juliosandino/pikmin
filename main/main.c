...
void app_main()
{
    ...
    // xTaskCreate(moisture_sensor_test, "moisture_sensor_test", configMINIMAL_STACK_SIZE * 3, NULL, 5, NULL);
    // xTaskCreate(blink_test, "blink_test", configMINIMAL_STACK_SIZE * 3, NULL, 5, NULL);
